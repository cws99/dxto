 ...
 * [dxto.yml](dxto.yml)
     * Determines how your purl.obolibrary.org/obo/dxto/ redirects will be handled
     ...
     * Paste in the contents of [dxto.yml](dxto.yml)
 ...
 * [dxto.md](dxto.md)
     ...
     * Paste in the contents of [dxto.md](dxto.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
